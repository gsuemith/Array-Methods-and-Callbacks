...
log(worldCupFinal2014['Away Team Name'])
//(c) Home Team goals for 2014 world cup final
log(worldCupFinal2014['Home Team Goals'])
//(d) Away Team goals for 2014 world cup final
log(worldCupFinal2014['Away Team Goals'])
//(e) Winner of 2014 world cup final */
log(worldCupFinal2014['Away Team Goals'] > worldCupFinal2014['Home Team Goals'] ? worldCupFinal2014['Away Team Name'] : worldCupFinal2014['Home Team Name'])
...
function getCountryWins(data, team) {
    ...
    /* code here */
    return finals.reduce((wins, game) => {
        const away = game["Away Team Initials"];
        const home = game["Home Team Initials"];
